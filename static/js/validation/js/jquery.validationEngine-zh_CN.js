/**
 * Created by Shadow Blade on 2015/12/23.
 */
	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"ajaxAccountCallHtml": {
					"url": "validateRegeditAccount.html",
					// you may want to pass extra data on the ajax call
					"extraData": "",
					// if you provide an "alertTextOk", it will show as a green prompt when the field validates
					"alertTextOk": "* 此账号可以使用",
					"alertText": "* 此账号已被其他人使用",
					"alertTextLoad": "* 正在确认账号是否有其他人使用，请稍等。"
				},
				"ajaxPhoneCallHtml": {
					"url": "validateMobile.html",
					// you may want to pass extra data on the ajax call
					"extraData": "",
					// if you provide an "alertTextOk", it will show as a green prompt when the field validates
